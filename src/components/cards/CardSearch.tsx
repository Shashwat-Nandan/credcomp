    ...
    <div ref={wrapperRef} className="relative w-full max-w-lg">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-gray-300 bg-white py-2.5 pl-10 pr-4 text-sm focus:border-[var(--color-accent)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)]/20"
          role="combobox"
